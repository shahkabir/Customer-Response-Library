...
function warning_one_min()
{
  alert("You have one minute to finish this call.");
}
...
function cancelAndRedirect()
{
	...
	window.location='http://blccdmis01/voc';
}

setTimeout(warning_one_min, 5000);
setTimeout(cancelAndRedirect, 10000);

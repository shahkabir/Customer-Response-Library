	    ...
	    <td>      
	    	<div align="left">
			    <div class="checkbox-div">
			    	<input type="checkbox" name="channels[]" value="Facebook" onclick="return ValidatePetSelection();"/> Facebook
			    </div>
			    <div class="checkbox-div">
			    	<input type="checkbox" name="channels[]" value="Email" onclick="return ValidatePetSelection();"> Email
				</div>
				<div class="checkbox-div">
			    	<input type="checkbox" name="channels[]" value="Playstore" onclick="return ValidatePetSelection();"> Playstore
				</div>
				<div class="checkbox-div">
			    	<input type="checkbox" name="channels[]" value="Youtube" onclick="return ValidatePetSelection();"> Youtube
				</div>
				<div class="checkbox-div">
			    	<input type="checkbox" name="channels[]" value="Instagram" onclick="return ValidatePetSelection();"> Instagram
				</div>
				<div class="checkbox-div">
			    	<input type="checkbox" name="channels[]" value="Twitter" onclick="return ValidatePetSelection();"> Twitter
				</div>

...
if(isset($_POST['btnsubmit']))
{
	...
	$sql =	"SELECT employee_name ,msisdn_txt ,con_type ,quest_one_ans ,quest_two_ans,quest_two_others ,VOCdetailsStoryline,txtstory,survey_date,survey_time ,callback FROM cust_survey WHERE survey_date BETWEEN '$startdate' AND '$enddate'";

...
if(isset($_POST['btnsubmit']))
{
	...
	$sql =	"   select
				b.name `Name`, a.employee_name `Email` , b.msisdn `Contact No.`, count(*) `Total`
				from cust_survey a left join emp_base b on a.employee_name=b.email

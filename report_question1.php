...
if(isset($_POST['btnsubmit']))
{
	...
	$sql =	"   select
				sum(if(`quest_one_ans`='Not at all satisfied',1,0)) `Not at all satisfied`,
				sum(if(`quest_one_ans`='Somewhat Satisfied',1,0)) `Somewhat Satisfied`,
				sum(if(`quest_one_ans`='Satisfied',1,0)) `Satisfied`,
				sum(if(`quest_one_ans`='Very Satisfied',1,0)) `Very Satisfied`
				from cust_survey
